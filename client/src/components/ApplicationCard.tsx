...
const ApplicationCard = ({
  ...
  const [imgSrc, setImgSrc] = useState(
    application.property?.photoUrls?.[0] || "/placeholder.jog"
  )
  ...
  return (
    <div className="border rounded-xl overflow-hidden shadow-sm bg-white mb-4">
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between px-6 md:px-4 py-6 gap-6 lg:gap-4">
        ...
        {/* Status Section */}
        <div className="flex flex-col justify-between w-full lg:basis-2/12 lg:h-48 py-2 gap-3 lg:gap-2">
          <div>
          ...
          <div className="flex justify-between">
            ...
            {new Date(application.lease?.nextPayment).toLocaleDateString()}
          </div>
        </div>
        ...
        <div className="flex flex-col justify-start gap-5 w-full lg:basis-3/12 lg:w-48 py-2">
          <div>
